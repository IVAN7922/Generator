const generatorButton = document.querySelector('.generator_btn'); // кнопка генерации
const generatorClearButton = document.querySelector('.generatorClear_btn'); // кнопка сброса результатов
